...
class OscServer(liblo.ServerThread):
    def __init__(self, window):
        ...
        # For DiLuz
        self.add_method('/sub/launch', None, self.sub_launch_cb) # Open Masters page
        self.add_method('/subStick/flash', 'ii', self.sub_flash_cb) # Flash Master (master number, level)
        self.add_method('/subStick/level', 'ii', self.sub_level_cb) # Master level (master number, level)

        # For TouchOSC
        self.add_method('/sub/1/level', 'f', self.sub1_level_cb) # Master 1 (float entre 0 et 255)
        self.add_method('/sub/2/level', 'f', self.sub2_level_cb) # Master 2 (float entre 0 et 255)
        self.add_method('/sub/3/level', 'f', self.sub3_level_cb) # Master 3 (float entre 0 et 255)
        self.add_method('/sub/4/level', 'f', self.sub4_level_cb) # Master 4 (float entre 0 et 255)
        self.add_method('/sub/5/level', 'f', self.sub5_level_cb) # Master 5 (float entre 0 et 255)
        self.add_method('/sub/6/level', 'f', self.sub6_level_cb) # Master 6 (float entre 0 et 255)
        self.add_method('/sub/7/level', 'f', self.sub7_level_cb) # Master 7 (float entre 0 et 255)
        self.add_method('/sub/8/level', 'f', self.sub8_level_cb) # Master 8 (float entre 0 et 255)
        self.add_method('/sub/9/level', 'f', self.sub9_level_cb) # Master 9 (float entre 0 et 255)
        self.add_method('/sub/10/level', 'f', self.sub10_level_cb) # Master 10 (float entre 0 et 255)
        self.add_method('/sub/11/level', 'f', self.sub11_level_cb) # Master 1A (float entre 0 et 255)
        self.add_method('/sub/12/level', 'f', self.sub12_level_cb) # Master 12 (float entre 0 et 255)
    ...
    def sub_launch_cb(self, path, args, types):
        """ Launch Sub page """
        for i in range(10):
            self.client.send('/subStick/text', ('i', i+1), ('s', self.app.masters[i].text))
