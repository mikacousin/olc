...
class VirtualConsoleWindow(Gtk.Window):
    ...
    def __init__(self, app: Application) -> None:
        ...
        self.zero = ButtonWidget("0", "number_0", self.app.midi)
        self.zero.connect("clicked", self._on_zero)
        self.one = ButtonWidget("1", "number_1", self.app.midi)
        self.one.connect("clicked", self._on_1)
        self.two = ButtonWidget("2", "number_2", self.app.midi)
        self.two.connect("clicked", self._on_2)
        self.three = ButtonWidget("3", "number_3", self.app.midi)
        self.three.connect("clicked", self._on_3)
        self.four = ButtonWidget("4", "number_4", self.app.midi)
        self.four.connect("clicked", self._on_4)
        self.five = ButtonWidget("5", "number_5", self.app.midi)
        self.five.connect("clicked", self._on_5)
        self.six = ButtonWidget("6", "number_6", self.app.midi)
        self.six.connect("clicked", self._on_6)
        self.seven = ButtonWidget("7", "number_7", self.app.midi)
        self.seven.connect("clicked", self._on_7)
        self.eight = ButtonWidget("8", "number_8", self.app.midi)
        self.eight.connect("clicked", self._on_8)
        self.nine = ButtonWidget("9", "number_9", self.app.midi)
        self.nine.connect("clicked", self._on_9)
        self.dot = ButtonWidget(".", "dot", self.app.midi)
        self.dot.connect("clicked", self._on_dot)
        self.clear = ButtonWidget("C", "clear", self.app.midi)
        ...
        self.time = ButtonWidget("Time", "time", self.app.midi)
        self.time.connect("clicked", self._on_time)
        self.delay = ButtonWidget("Delay", "delay", self.app.midi)
        self.delay.connect("clicked", self._on_delay)
        self.button_in = ButtonWidget("In", self.app.midi)
        self.button_out = ButtonWidget("Out", self.app.midi)
        ...
        self.seq = ButtonWidget("Seq", "seq", self.app.midi)
        self.seq.connect("clicked", self._on_seq)
        self.empty1 = ButtonWidget(" ", self.app.midi)
        self.empty2 = ButtonWidget(" ", self.app.midi)
        self.preset = ButtonWidget("Preset", "preset", self.app.midi)
        self.preset.connect("clicked", self._on_preset)
        self.group = ButtonWidget("Group", "group", self.app.midi)
        self.group.connect("clicked", self._on_group)
        self.effect = ButtonWidget("Effect", self.app.midi)
        ...
        self.output = ButtonWidget("Output", "output", self.app.midi)
        ...
        self.update = ButtonWidget("Update", "update", self.app.midi)
        self.update.connect("clicked", self._on_update)
        self.record = ButtonWidget("Record", "record", self.app.midi)
        self.record.connect("clicked", self._on_record)
        self.track = ButtonWidget("Track", "track", self.app.midi)
        ...
        self.thru = ButtonWidget("Thru", "thru", self.app.midi)
        self.thru.connect("clicked", self._on_thru)
        self.channel = ButtonWidget("Ch", "ch", self.app.midi)
        self.channel.connect("clicked", self._on_channel)
        self.plus = ButtonWidget("+", "plus", self.app.midi)
        self.plus.connect("clicked", self._on_plus)
        self.minus = ButtonWidget("-", "minus", self.app.midi)
        self.minus.connect("clicked", self._on_minus)
        self.all = ButtonWidget("All", "all", self.app.midi)
        self.all.connect("clicked", self._on_all)
        self.at_level = ButtonWidget("@", "at", self.app.midi)
        self.at_level.connect("clicked", self._on_at)
        self.percent_plus = ButtonWidget("+%", "percent_plus", self.app.midi)
        self.percent_plus.connect("clicked", self._on_percent_plus)
        self.percent_minus = ButtonWidget("-%", "percent_minus", self.app.midi)
        ...
        self.insert = ButtonWidget("Insert", self.app.midi)
        self.delete = ButtonWidget("Delete", self.app.midi)
        self.esc = ButtonWidget("Esc", self.app.midi)
        self.modify = ButtonWidget("Modify", self.app.midi)
        self.up = ButtonWidget("^", "up", self.app.midi)
        self.up.connect("clicked", self._on_up)
        self.down = ButtonWidget("v", "down", self.app.midi)
        self.down.connect("clicked", self._on_down)
        self.left = ButtonWidget("<", "left", self.app.midi)
        self.left.connect("clicked", self._on_left)
        self.right = ButtonWidget(">", "right", self.app.midi)
        ...
        self.live = ButtonWidget("Live", self.app.midi)
        self.format = ButtonWidget("Format", self.app.midi)
        self.blind = ButtonWidget("Blind", self.app.midi)
        self.goto = ButtonWidget("Goto", "goto", self.app.midi)
        self.goto.connect("clicked", self._on_goto)
        self.a = ButtonWidget("A", self.app.midi)
        self.b = ButtonWidget("B", self.app.midi)
        ...
        self.seq_plus = ButtonWidget("Next Cue", "seq_plus", self.app.midi)
        self.seq_plus.connect("clicked", self._on_seq_plus)
        self.seq_minus = ButtonWidget("Prev Cue", "seq_minus", self.app.midi)
        self.seq_minus.connect("clicked", self._on_seq_minus)
        self.goback = ButtonWidget("Go Back", "go_back", self.app.midi)
        ...
        self.fader_page_plus = ButtonWidget("Page+", "page_plus", self.app.midi)
        self.fader_page_plus.connect("clicked", self._on_fader_page)
        self.fader_page_minus = ButtonWidget("Page-", "page_minus", self.app.midi)
